...
class Detector3DTemplate(nn.Module):
    ...
    def _load_state_dict(self, model_state_disk, *, strict=True):
        ...
        # print("------------model state_dict----------------:", model_state_disk.keys())
        # assert False
        update_model_state = {}
        for key, val in model_state_disk.items():
            ...
            if key not in state_dict:
                ...
                component_list.insert(-1, "conv_block")
                new_key = ".".join(component_list)
                # if new_key in state_dict:
                #     print("key:", key, "new_key:", new_key, "state_dict[new_key].shape:", state_dict[new_key].shape, "val.shape", val.shape)
                if new_key in state_dict and state_dict[new_key].shape == val.shape:
